...
import { text } from './../middles/nodes/text/text';
...
export class Line extends Pen {
  ...
  setTo(to: Point, toArrow: string = 'none') {
    this.to = to;
  ...
  draw(ctx: CanvasRenderingContext2D) {
    ...
    let scale = Store.get(this.generateStoreKey('LT:scale')) || 1;
